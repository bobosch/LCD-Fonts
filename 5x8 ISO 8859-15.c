...
const unsigned char font[0x100][5] = {
    ...
    {0x08, 0x55, 0x56, 0x55, 0x20}, // 0xA6 Š
    {0x00, 0x66, 0x89, 0x95, 0x6A}, // 0xA7 §
    {0x00, 0x59, 0x7A, 0x69, 0x00}, // 0xA8 š
    {0x38, 0x7C, 0x6C, 0x44, 0x38}, // 0xA9 ©
    {0x26, 0x29, 0x29, 0x2F, 0x28}, // 0xAA ª
    ...
    {0x44, 0x65, 0x56, 0x4D, 0x44}, // 0xB4 Ž
    {0x40, 0x7E, 0x20, 0x1E, 0x20}, // 0xB5 µ
    {0x06, 0x09, 0x7F, 0x01, 0x7F}, // 0xB6 ¶
    {0x00, 0x00, 0x08, 0x00, 0x00}, // 0xB7 ·
    {0x00, 0x69, 0x7A, 0x59, 0x00}, // 0xB8 ž
    {0x00, 0x12, 0x1F, 0x10, 0x00}, // 0xB9 ¹
    {0x26, 0x29, 0x29, 0x29, 0x26}, // 0xBA º
    {0x22, 0x14, 0x2A, 0x14, 0x08}, // 0xBB »
    {0x3E, 0x41, 0x7F, 0x49, 0x41}, // 0xBC Œ
    {0x38, 0x44, 0x38, 0x54, 0x18}, // 0xBD œ
    {0x04, 0x09, 0x70, 0x09, 0x04}, // 0xBE Ÿ
    {0x30, 0x48, 0x4D, 0x40, 0x20}, // 0xBF ¿
    {0x70, 0x28, 0x25, 0x2A, 0x70}, // 0xC0 À
    {0x70, 0x2A, 0x25, 0x28, 0x70}, // 0xC1 Á
    {0x70, 0x2A, 0x25, 0x2A, 0x70}, // 0xC2 Â
    {0x70, 0x2A, 0x25, 0x2A, 0x71}, // 0xC3 Ã
    {0x70, 0x29, 0x24, 0x29, 0x70}, // 0xC4 Ä
    {0x70, 0x28, 0x25, 0x28, 0x70}, // 0xC5 Å
    {0x7C, 0x12, 0x7F, 0x49, 0x41}, // 0xC6 Æ
    {0x1E, 0xA1, 0xA1, 0x61, 0x12}, // 0xC7 Ç
    {0x7C, 0x54, 0x55, 0x46, 0x00}, // 0xC8 È
    {0x7C, 0x56, 0x55, 0x44, 0x00}, // 0xC9 É
    {0x7C, 0x56, 0x55, 0x46, 0x00}, // 0xCA Ê
    {0x7C, 0x55, 0x54, 0x45, 0x00}, // 0xCB Ë
    {0x00, 0x44, 0x7D, 0x46, 0x00}, // 0xCC Ì
    {0x00, 0x46, 0x7D, 0x44, 0x00}, // 0xCD Í
    {0x00, 0x46, 0x7D, 0x46, 0x00}, // 0xCE Î
    {0x00, 0x45, 0x7C, 0x45, 0x00}, // 0xCF Ï
    {0x7F, 0x49, 0x41, 0x41, 0x3E}, // 0xD0 Ð
    {0x7C, 0x0E, 0x19, 0x32, 0x7D}, // 0xD1 Ñ
    {0x38, 0x44, 0x45, 0x46, 0x38}, // 0xD2 Ò
    {0x38, 0x46, 0x45, 0x44, 0x38}, // 0xD3 Ó
    {0x38, 0x46, 0x45, 0x46, 0x38}, // 0xD4 Ô
    {0x38, 0x46, 0x45, 0x46, 0x39}, // 0xD5 Õ
    {0x38, 0x45, 0x44, 0x45, 0x38}, // 0xD6 Ö
    {0x00, 0x14, 0x08, 0x14, 0x00}, // 0xD7 ×
    {0x3C, 0x32, 0x2A, 0x26, 0x1E}, // 0xD8 Ø
    {0x3C, 0x40, 0x41, 0x42, 0x3C}, // 0xD9 Ù
    {0x3C, 0x42, 0x41, 0x40, 0x3C}, // 0xDA Ú
    {0x3C, 0x42, 0x41, 0x42, 0x3C}, // 0xDB Û
    {0x3C, 0x41, 0x40, 0x41, 0x3C}, // 0xDC Ü
    {0x04, 0x0A, 0x71, 0x08, 0x04}, // 0xDD Ý
    {0x7E, 0x24, 0x24, 0x24, 0x18}, // 0xDE Þ
    {0x7C, 0x2A, 0x2A, 0x3E, 0x14}, // 0xDF ß
    {0x20, 0x54, 0x55, 0x7A, 0x40}, // 0xE0 à
    {0x20, 0x56, 0x55, 0x78, 0x40}, // 0xE1 á
    {0x20, 0x56, 0x55, 0x7A, 0x40}, // 0xE2 â
    {0x20, 0x56, 0x55, 0x7A, 0x41}, // 0xE3 ã
    {0x20, 0x55, 0x54, 0x79, 0x40}, // 0xE4 ä
    {0x20, 0x54, 0x55, 0x78, 0x40}, // 0xE5 å
    {0x20, 0x54, 0x38, 0x54, 0x18}, // 0xE6 æ
    {0x18, 0x3C, 0xA4, 0xE4, 0x24}, // 0xE7 ç
    {0x38, 0x54, 0x55, 0x56, 0x18}, // 0xE8 è
    {0x38, 0x56, 0x55, 0x54, 0x18}, // 0xE9 é
    {0x38, 0x56, 0x55, 0x56, 0x18}, // 0xEA ê
    {0x38, 0x55, 0x54, 0x55, 0x18}, // 0xEB ë
    {0x00, 0x44, 0x7D, 0x42, 0x00}, // 0xEC ì
    {0x00, 0x46, 0x7D, 0x40, 0x00}, // 0xED í
    {0x00, 0x46, 0x7D, 0x42, 0x00}, // 0xEE î
    {0x00, 0x45, 0x7C, 0x41, 0x00}, // 0xEF ï
    {0x38, 0x45, 0x45, 0x47, 0x38}, // 0xF0 ð
    {0x7C, 0x0A, 0x05, 0x06, 0x79}, // 0xF1 ñ
    {0x38, 0x44, 0x45, 0x46, 0x38}, // 0xF2 ò
    {0x38, 0x46, 0x45, 0x44, 0x38}, // 0xF3 ó
    {0x38, 0x46, 0x45, 0x46, 0x38}, // 0xF4 ô
    {0x38, 0x46, 0x45, 0x46, 0x39}, // 0xF5 õ
    {0x38, 0x45, 0x44, 0x45, 0x38}, // 0xF6 ö
    {0x08, 0x08, 0x6B, 0x6B, 0x08}, // 0xF7 ÷
    {0x3C, 0x32, 0x2A, 0x26, 0x1E}, // 0xF8 ø
    {0x3C, 0x40, 0x41, 0x22, 0x7C}, // 0xF9 ù
    {0x3C, 0x42, 0x41, 0x20, 0x7C}, // 0xFA ú
    {0x3C, 0x42, 0x41, 0x22, 0x7C}, // 0xFB û
    {0x3C, 0x41, 0x40, 0x21, 0x7C}, // 0xFC ü
    {0x4C, 0x92, 0x91, 0x90, 0x7C}, // 0xFD ý
    {0xFF, 0x22, 0x22, 0x22, 0x1C}, // 0xFE þ
    {0x4C, 0x91, 0x90, 0x91, 0x7C}, // 0xFF ÿ
};
